...
class HistoryBarangHilangPage extends StatefulWidget {
  const HistoryBarangHilangPage({Key? key});

  @override
  State<HistoryBarangHilangPage> createState() => _HistoryBarangHilangPageState();
}

class _HistoryBarangHilangPageState extends State<HistoryBarangHilangPage> {
...
class EditButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: CustomButton(
        onPressed: () {
          Navigator.pushNamed(context, '/edit-barang');
        },
        label: 'Edit Laporan',
      ),
    );
