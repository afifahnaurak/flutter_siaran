...
class EditBarangHilangPage extends StatefulWidget {
  const EditBarangHilangPage({Key? key});

  @override
  State<EditBarangHilangPage> createState() => _EditBarangHilangPageState();
}

class _EditBarangHilangPageState extends State<EditBarangHilangPage> {
